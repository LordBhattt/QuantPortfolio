...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: "0 1px 3px hsl(var(--foreground) / 0.06), 0 4px 16px hsl(var(--foreground) / 0.08), 0 12px 40px hsl(var(--foreground) / 0.04)",
        "card-hover":
          "0 2px 8px hsl(var(--foreground) / 0.08), 0 8px 32px hsl(var(--foreground) / 0.12), 0 24px 60px hsl(var(--foreground) / 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
